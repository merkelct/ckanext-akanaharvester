...
setup(
    ...
    description='''Harvest the Akana gateway protal api.''',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/merkelct/ckanext-akanaharvester',
    ...
    keywords='''CKAN akana harvester monsanto''',
